...
$(document).ready(function(){
  ...
  $('#city-one').innerHTML = `${historyArr[0]}`;
  $('#city-two').innerHTML = `${historyArr[1]}`;
  $('#city-three').innerHTML = `${historyArr[2]}`;
  $('#city-four').innerHTML = `${historyArr[3]}`;
  $('#city-five').innerHTML = `${historyArr[4]}`;
